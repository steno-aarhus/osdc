...
-   `itwo3`: Insulin makes up at least two-thirds of total GLD
    doses.
...
-   `gld`: Inclusion event from a Glucose-Lowering Drug
    purchase.
-   `diag`: Inclusion event from a diabetes diagnosis.
-   `hba1c`: Inclusion event from a high HbA1c measurement.
-   `pod`: Inclusion event from a diabetes-specific podiatrist
    service.
...
-   `female_u40_pcosT`: A female patient under 40 whose
    metformin purchases should be censored for potential PCOS.
-   `female_o40_pcosT`: A female patient over 40 whose
