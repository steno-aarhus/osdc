...
-   **Logic Tested**: The patient has a majority of T1D diagnoses and a
    ...
    more than 180 days after the first-ever GLD purchase. This fails the
...
-   **Key Data Points**:
    ...
    -   Has a majority of T1D-specific *secondary* diagnoses from
        endocrinology departments and a majority of T1D-specific primary
        diagnoses from *non-endocrinology* departments, which are both
