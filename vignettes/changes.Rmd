...
2. For diabetes type-classification, the window of 180 days when a T1D case must make a purchase of an insulin is now evaluated from the date of the first purchase of a glucose-lowering drug, rather than from the inclusion date.
