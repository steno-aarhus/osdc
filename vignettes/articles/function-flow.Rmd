...
#' Keeps only those with 2 or more events.
#'
...
#'   - `stable_inclusion_date`: Date of inclusion of those with after medication
#'     data contributes to inclusions. Limits the included cohort to only individuals
#'     with valid date of inclusion (and thereby valid age at inclusion & duration of diabetes).
#'
#' @keywords internal
#' @inherit algorithm seealso
