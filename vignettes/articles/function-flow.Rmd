...
We use this document mainly for us (the developers) to coordinate what needs to
be done and how all the pieces fit together. We also use this document to create
pseudocode of the internal functions before actually implementing them. The
sections are split into inclusion and exclusion functions as well as the
