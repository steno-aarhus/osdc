...
and the common virtual working environment potentially enables
reproducible research. This means that any data processing workflow
could be transferable and usable between research projects if the
...
In Denmark, the first resource readily available to researchers to
identify diabetes cases through register data was the National Diabetes
Register, which was established in 2006 [@Carstensen2011] but then
discontinued in 2012.

The next resource is the Register of Selected Chronic Diseases (RSCD),
