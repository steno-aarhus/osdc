...
flowchart TD
  ...
  subgraph classify_diabetes["classify_diabetes()"]
    ...
    %% Exclusion steps
    keep_gld_purchases --> exclude_potential_pcos["exclude_potential_pcos()"]:::exclude
    bef --> exclude_potential_pcos

    exclude_potential_pcos --> exclude_pregnancies["exclude_pregnancies()"]:::exclude
    keep_pregnancy_dates --> exclude_pregnancies
    keep_hba1c --> exclude_pregnancies
    exclude_pregnancies --> add_insulin_purchases_cols["add_insulin_purchases_cols()"]
...
See `?exclude_pregnancies` for more information.
...
#'   `exclude_pregnancies()`, and the `n_t1d_endocrinology`,
...
create_inclusion_dates <- function(inclusions, stable_inclusion_start_date = "1998-01-01") {
  inclusions |>
    ...
    dplyr::select(
      ...
      # From `exclude_pregnancies()` via the GLD purchases
