...
::: content-hidden
In the mermaid diagram below, invisible edges (~~~) are used solely for layout purposes to help position the nodes.
:::
...
flowchart TD
  ...
  subgraph classify_diabetes["classify_diabetes()"]
    ...
    include_diabetes_diagnoses --> add_majority_t1d_diagnosis_col["add_majority_t1d_diagnosis_col()"]
    ...
    %% Joining
    add_majority_t1d_diagnosis_col --> join_inclusions["join_inclusions()"]
    ...
    get_pregnancy_dates ~~~ exclude_potential_pcos
