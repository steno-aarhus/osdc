...
In brief, the algorithm first identifies a diabetes population---regardless of diabetes type---
based on four types of inclusion events. It then classifies individuals within this population
as having type 1 diabetes (T1D) based on
patterns in glucose-lowering drug purchases and recorded
type-specific diabetes diagnoses. Individuals who do not meet the criteria for T1D
are subsequently classified as having type 2 diabetes (T2D).

The diabetes classification date is defined at the date of the
...
1.  HbA1c samples:
    -   Samples taken during pregnancies, as these may be
        related to gestational diabetes mellitus rather than
        T1D or T2D.
2.  Glucose-lowering drugs:
    ...
    -   Purchases made during pregnancies, as these may be
        related to gestational diabetes mellitus, rather than
        T1D or T2D.
    -   Purchases of metformin by women below age 40, as these may be
        treatment for polycystic ovary syndrome (PCOS).
    -   Purchases of metformin with a PCOS-related indication code.
...
For an individual to be classified as having T1D, the available data needs to fulfil either of the
following combinations of criteria:

a.  Must only have recorded purchases of insulin drugs and never any other type of
