...
As described in the [design](design.Rmd) vignette, inclusion date is the
date of the second inclusion criteria. Inclusion events include:
...
the function `extract_inclusion_dates`. For each individual with
inclusion events, the date of the *second* event is extracted as the
inclusion date, i.e., the date the OSDC algorithm defines as the
diagnosis date.
