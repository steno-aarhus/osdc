...
3. The raw" inclusion date (i.e., the date of the second instance of the
   inclusion criteria described in the sections above).
4. The classified diabetes type

*For more information on "raw" versus "stable" inclusion date, see the [Description of algorithm contents & logic](algorithm_logic.Rmd) vignette.
