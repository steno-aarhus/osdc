...
expected <- tibble::tribble(
  ...
  ## ATC matches criteria
  ### Age at purchase matches criteria (< 40)
  1000000001, as.Date("2010-02-02"), "A10BA02", 1.21, TRUE, "324314324", TRUE,
  1000000001, as.Date("2010-02-02"), "A10BA02", 1.21, TRUE, "0000092", TRUE, # indication_code matches
  ### Age at purchase doesn't match (= 40)
  1000000001, as.Date("2020-02-02"), "A10BA02", 1.21, TRUE, "324314324", TRUE,
  1000000001, as.Date("2020-02-02"), "A10BA02", 1.21, TRUE, "0000781", TRUE, # indication_code matches
  ### Age at purchase doesn't match (> 40)
  1000000001, as.Date("2025-02-02"), "A10BA02", 1.21, TRUE, "324314324", TRUE,
  1000000001, as.Date("2025-02-02"), "A10BA02", 1.21, TRUE, "0000276", TRUE, # indication_code matches
  ## ATC doesn't match criteria
  ### Age at purchase matches criteria (< 40)
  1000000001, as.Date("2010-02-02"), "A10", 1.21, TRUE, "324314324", TRUE,
  1000000001, as.Date("2010-02-02"), "A10", 1.21, TRUE, "0000092", TRUE, # indication_code matches
  ### Age at purchase doesn't match (= 40)
  1000000001, as.Date("2020-02-02"), "A10", 1.21, TRUE, "324314324", TRUE,
  1000000001, as.Date("2020-02-02"), "A10", 1.21, TRUE, "0000781", TRUE, # indication_code matches
  ### Age at purchase doesn't match (> 40)
  1000000001, as.Date("2025-02-02"), "A10", 1.21, TRUE, "324314324", TRUE,
  1000000001, as.Date("2025-02-02"), "A10", 1.21, TRUE, "0000276", TRUE, # indication_code matches

  # Women (as defined by PNR)
  ## ATC matches criteria
  ### Age at purchase matches criteria (< 40)
  ### Age at purchase doesn't match (= 40)
  2000000000, as.Date("2020-02-02"), "A10BA02", 1.21, TRUE, "324314324", TRUE,
  ### Age at purchase doesn't match (> 40)
  2000000000, as.Date("2025-02-02"), "A10BA02", 1.21, TRUE, "324314324", TRUE,
  ## ATC doesn't match criteria
  ### Age at purchase matches criteria (< 40)
  2000000000, as.Date("2010-02-02"), "A10", 1.21, TRUE, "324314324", TRUE,
  2000000000, as.Date("2010-02-02"), "A10", 1.21, TRUE, "0000092", TRUE, # indication_code matches
  ### Age at purchase doesn't match (= 40)
  2000000000, as.Date("2020-02-02"), "A10", 1.21, TRUE, "324314324", TRUE,
  2000000000, as.Date("2020-02-02"), "A10", 1.21, TRUE, "0000781", TRUE, # indication_code matches
  ### Age at purchase doesn't match (> 40)
  2000000000, as.Date("2025-02-02"), "A10", 1.21, TRUE, "324314324", TRUE,
  2000000000, as.Date("2025-02-02"), "A10", 1.21, TRUE, "0000276", TRUE, # indication_code matches
)
