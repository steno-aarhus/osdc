...
test_df <- tibble::tibble(
  pnr = c(rep("000000000000000001", 4), rep("000000000000000002", 3),
          rep("000000000000000003", 3), "000000000000000004"),
  is_t1d =      c(TRUE, TRUE, FALSE, FALSE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE, TRUE),
  is_t2d =      c(FALSE, FALSE, TRUE, TRUE, FALSE, FALSE, TRUE, TRUE, TRUE, FALSE, FALSE),
  is_primary =  c(TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, TRUE),
  department =  c("endocrinology", "endocrinology", "endocrinology", "other medical",
                  "endocrinology", "other medical", "other medical",
                  "other medical", "endocrinology", "non-medical",
                  "other medical")
)
...
test_that("pnr 000000000000000001 has correct counts", {
...
test_that("pnr 000000000000000002 has correct counts", {
...
test_that("pnr 000000000000000003 has correct counts", {
  row <- output_df |> dplyr::filter(pnr == "000000000000000003") |> dplyr::slice_head(n = 1)

  expect_equal(row$n_t1d_endocrinology, 0)
  expect_equal(row$n_t2d_endocrinology, 0)  # Only non-primary in endo
  expect_equal(row$n_t1d_medical, 0)
  expect_equal(row$n_t2d_medical, 1)
})

test_that("pnr 000000000000000004 has correct counts", {
