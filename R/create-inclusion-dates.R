...
#'
#' This function defines the final inclusion dates, raw and stable
...
#'
#' @param inclusions Data with inclusion events passed from the internal
#'  `join_inclusions()`
...
create_inclusion_dates <- function(
  ...
  inclusions |>
    ...
    dplyr::select(
      ...
      "from_diabetes_diagnosis",
      "from_podiatrist_service",
      "from_gld_purchase",
      "from_hba1c_over_threshold",
