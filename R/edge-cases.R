...
#'
#' The generated data is used in `testthat` tests to ensure the
#' algorithm behaves as expected under a wide range of conditions, but it is also intended to be explored by users to better understand how the algorithm logic works.
#'
...
#' Create the expected output tibble for included edge cases
#'
#' This function generates the expected output for all cases in the
#' `create_test_cases()` data. Each row specifies the expected inclusion dates and diabetes type for an included `pnr`.
#'
#' The generated data is used in `testthat` tests to ensure the
#' algorithm behaves as expected under a wide range of conditions, but it is also intended to be explored by users to better understand how the algorithm logic works.
#'
...
#' @examples
#' \dontrun{
#' expected_inclusions <- create_expected_inclusions()
#' }
